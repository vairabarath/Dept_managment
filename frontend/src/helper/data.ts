...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 11, 20, 9, 30),
    end: new Date(2024, 11, 20, 10, 20),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 11, 20, 10, 20),
    end: new Date(2024, 11, 20, 11, 10),
  },
  // {
  //   title: "interval",
  //   allDay: false,
  //   start: new Date(2024, 11, 10, 11, 10),
  //   end: new Date(2024, 11, 10, 11, 20),
  //   className: "short-event",
  // },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 11, 20, 11, 20),
    end: new Date(2024, 11, 20, 12, 10),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 11, 20, 12, 10),
  ...
  },
  {
    ...
    end: new Date(2024, 11, 20, 14, 55),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 11, 20, 14, 55),
    end: new Date(2024, 11, 20, 15, 45),
  },
];
