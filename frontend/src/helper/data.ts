...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 11, 9, 9, 30),
    end: new Date(2024, 11, 9, 10, 20),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 11, 9, 10, 20),
    end: new Date(2024, 11, 9, 11, 10),
  },
  // {
  //   title: "interval",
  //   allDay: false,
  //   start: new Date(2024, 11, 9, 11, 10),
  //   end: new Date(2024, 11, 9, 11, 20),
  //   className: "short-event",
  // },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 11, 9, 11, 20),
    end: new Date(2024, 11, 9, 12, 10),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 11, 9, 12, 10),
    end: new Date(2024, 11, 9, 13, 0),
  },
  {
    title: "Lunch",
    allDay: false,
    start: new Date(2024, 11, 9, 13, 0),
    end: new Date(2024, 11, 9, 14, 0),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 11, 9, 14, 0),
    end: new Date(2024, 11, 9, 14, 55),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 11, 9, 14, 55),
    end: new Date(2024, 11, 9, 15, 45),
  },
];
